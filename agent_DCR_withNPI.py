...
async def fetch_multiple_doctors(doctors_list: List[Dict[str, str]], output_file="Phyrago_left_hcps_results.xlsx"):
...
def load_doctors_from_excel(file_path: str) -> List[Dict[str, str]]:
    ...
    df = df[required_columns].loc[102:104, :]
    df.columns = ["npi", "provider_name", "specialty", "city", "state"]
    return df.to_dict(orient="records")

# Example Usage
if __name__ == "__main__":
    input_file = r"C:\Projects\ai-agent\input\Phyrago_left_hcps.xlsx"

...
async def fetch_multiple_doctors(doctors_list: List[Dict[str, str]], output_file="May22nd_DCR_hcp_aff.xlsx"):
...
def load_doctors_from_excel(file_path: str) -> List[Dict[str, str]]:
    ...
    df = df[required_columns].loc[: , :]   # Fetching range
    df.columns = ["provider_name", "specialty", "city", "state"]
    return df.to_dict(orient="records")

# Example Usage
if __name__ == "__main__":
    input_file = r"C:\Projects\ai-agent\input\DCR_hcps_May_22nd.xlsx"
